...
function Box({ title }: { title: string }) {
  return (
    <div
      data-title={title}
      className="after:bg-light-blue dark:after:bg-dark-blue red:after:bg-dark-red relative max-w-120 rounded-sm border-2 p-4 after:absolute after:top-0 after:right-0 after:-translate-x-4 after:-translate-y-1/2 after:px-2 after:content-[attr(data-title)]"
    >
